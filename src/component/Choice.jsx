	...
	return (
		<div id='occation'>
			...
			<div className="container m-auto p-3">
  					...
  					<div className="card2 m-auto p-3 flex gap-5 justify-center items-center flex-col md:flex-row">
  						<img src="img/1/108855053.webp" alt="food" className='w-3/4 md:w-1/4 mb-5 md:mb-0'/>
  						<div>
  						<h1 className='text-3xl'>dolor sit amet consectetur adipisicing elit</h1>
  						<p className='mt-4 text-gray-700'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque, illum nostrum consequatur natus velit provident sapiente fugit labore, corrupti sunt, fugiat quos ut aliquam reprehenderit minima. Asperiores est nemo, nobis.</p>
  						</div>
  					</div>
  					<div className="card2 m-auto p-3 flex gap-5 justify-center items-center flex-col md:flex-row">
  						<img src="img/1/108855262.webp" alt="food" className='w-3/4 md:w-1/4 mb-5 md:mb-0'/>
  						<div>
  						<h1 className='text-3xl'>dolor sit amet consectetur adipisicing elit</h1>
  						<p className='mt-4 text-gray-700'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aspernatur facilis vero quasi maxime laboriosam itaque vel laudantium, consequatur, natus voluptatum, in sapiente, nemo aperiam! Ratione minus tenetur sunt explicabo nam.</p>
  						</div>
  					</div>
  					<div className="card2 m-auto p-3 flex gap-5 justify-center items-center flex-col md:flex-row">
